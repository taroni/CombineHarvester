...
for mydir in onlydirs:
    ...
    for mass in massPoints:
        ...
        if 'le1' in mydir:
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_1_13TeV_%s.root --rMax 5.  -m %s > diagnostic_1_B_%s.txt" %(str(mass),str(mass), str(mass)))
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_2_13TeV_%s.root --rMax 5.  -m %s > diagnostic_2_B_%s.txt" %(str(mass),str(mass),str(mass)))
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_13TeV.root --rMax 5.  -m %s > diagnostic_B_%s.txt "%(str(mass),str(mass)) )
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_1_13TeV_%s.root --rMax 5. -m %s > diagnostic_1_S_%s.txt" %(str(mass),str(mass),str(mass)))
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_2_13TeV_%s.root --rMax 5.  -m %s > diagnostic_2_S_%s.txt" %(str(mass),str(mass), str(mass)))
            ...
            os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_13TeV.root --rMax 5.  -m %s > diagnostic_S_%s.txt"%(str(mass),str(mass)) )
