...
for mydir in onlydirs:
    ...
    for mass in massPoints:
        ...
        if 'le1' in mydir:
            ...
            os.system("combineCards.py lfv_em_1_13TeV_%s.txt lfv_em_2_13TeV_%s.txt lfv_et_1_13TeV_%s.txt lfv_et_2_13TeV_%s.txt > lfv_13TeV.txt" %(str(mass), str(mass),str(mass), str(mass)))
            os.system("combineTool.py -M T2W -i lfv_13TeV.txt  -o lfv_13TeV.root --parallel 4 -m %s" %(str(mass)))
            os.system("combineCards.py lfv_em_1_13TeV_%s.txt  lfv_et_1_13TeV_%s.txt  > lfv_1_13TeV_%s.txt" %(str(mass), str(mass), str(mass)))
            os.system("combineCards.py lfv_em_2_13TeV_%s.txt  lfv_et_2_13TeV_%s.txt  > lfv_2_13TeV_%s.txt" %(str(mass), str(mass), str(mass)))
            os.system("combineTool.py -M T2W -i lfv_2_13TeV_%s.txt  -o lfv_2_13TeV_%s.root --parallel 4 -m %s" %(str(mass), str(mass), str(mass)))
            os.system("combineTool.py -M T2W -i lfv_1_13TeV_%s.txt  -o lfv_1_13TeV_%s.root --parallel 4 -m %s" %(str(mass), str(mass), str(mass)))
    #os.chdir(join(cwd,mydir))
        ...
        if 'le1' in mydir:
            ...
            os.system("combineTool.py -M AsymptoticLimits -d lfv_13TeV.root --there  -n .limit --run expected -C 0.95 -t -1  -m %s --parallel 4" %(str(mass) ))
            os.system("combineTool.py -M AsymptoticLimits -d lfv_1_13TeV_%s.root --there  -n .limit1 --run expected -C 0.95 -t -1  -m %s --parallel 4" %(str(mass), str(mass) ))
            os.system("combineTool.py -M AsymptoticLimits -d lfv_2_13TeV_%s.root --there  -n .limit2 --run expected -C 0.95 -t -1  -m %s --parallel 4" %(str(mass), str(mass) ))
