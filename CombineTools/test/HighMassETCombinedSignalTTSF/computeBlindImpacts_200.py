...
cmd0="combineTool.py -M Impacts -d lfv_13TeV.root -m "+mass+" --doInitialFit --robustFit 1  --rMax 5 --rMin -5 --expectSignal 1 -t -1 --task-name combined -n combined"
os.system(cmd0)
...
cmd1="combineTool.py -M Impacts -d lfv_1_13TeV_"+mass+".root -m "+mass+" --robustFit 1 --doFits  --rMax 5 --rMin -5  -t -1 --expectSignal 1 --parallel 30 --task-name 0jet -n 0jet"
os.system(cmd1)
...
cmd1="combineTool.py -M Impacts -d lfv_2_13TeV_"+mass+".root -m "+mass+" --robustFit 1 --doFits  --rMax 5 --rMin -5 --expectSignal 1  -t -1 --parallel 30 --task-name 1jet -n 1jet"
os.system(cmd1)
