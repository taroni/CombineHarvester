...
for mydir in onlydirs:
    ...
    for mass in massPoints:
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_et_1_13TeV.root --rMax 5.  -m %s > diagnostic_1_B_%s.txt" %(str(mass), str(mass)))
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_et_2_13TeV.root --rMax 5.  -m %s > diagnostic_2_B_%s.txt" %(str(mass),str(mass)))
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 0 lfv_et_13TeV.root --rMax 5.  -m %s > diagnostic_B_%s.txt "%(str(mass), str(mass)) )
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_et_1_13TeV.root --rMax 5. -m %s > diagnostic_1_S_%s.txt" %(str(mass),str(mass)))
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_et_2_13TeV.root --rMax 5.  -m %s > diagnostic_2_S_%s.txt" %(str(mass), str(mass)))
        ...
        os.system("combine -M MaxLikelihoodFit -t -1 --expectSignal 1 lfv_et_13TeV.root --rMax 5.  -m %s > diagnostic_S_%s.txt"%(str(mass), str(mass)) )
