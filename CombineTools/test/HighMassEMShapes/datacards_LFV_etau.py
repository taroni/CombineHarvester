...
onlyfiles = ['shapes_em_HighMass.root', 
    'shapes_em_LowMass.root']
...
for infile in onlyfiles:
    ...
    bkg_procs = [ "DY", "DYTT", "ttbar", "singlet","EWKDiboson", "QCD", "W", "SMH" ] # I removed SMH
    mcbkg_procs = [ "DY", "DYTT", "ttbar", "singlet","EWKDiboson", "W", "SMH"] # I removed SMH
